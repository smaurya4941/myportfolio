...
const Experience = () => {
    return (
        <div id='experience' className='text-white md:flex overflow-hidden items-center md:flex-wrap md:justify-center bg-[#425b66] shadow-xl mx-0 md:mx-20 bg-opacity-30 rounded-lg p-12 mt-2 '>
