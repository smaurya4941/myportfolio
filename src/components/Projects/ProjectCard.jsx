...
const ProjectCard = ({title ,main,tech,demolink,sourcelink,image}) => {
  return (
    <div className='p-3 py-0 md:p-6 flex flex-col w-80 bg-[#75ab42] shadow-xl shadow-slate-900 rounded-2xl '>
        ...
        <p className='px-4 text-lg md:text-md leading-tight py-1 '>{main}</p>
        <p className='px-4 text-lg md:text-md  leading-tight py-1'><span className='font-bold text-black' >Technology Used: </span>{tech}</p>
